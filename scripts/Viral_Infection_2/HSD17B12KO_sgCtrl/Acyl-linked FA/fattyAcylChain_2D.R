...
se <- readRDS(file.path(dataPATH, "fattyAcylChain_2D.rds"))
...
ggplot2::ggsave(file.path(outPATH, "fattyAcylChain_2D_oddChain_plot.pdf"), plot$odd_result, width = 6.5, height = 4.5)
