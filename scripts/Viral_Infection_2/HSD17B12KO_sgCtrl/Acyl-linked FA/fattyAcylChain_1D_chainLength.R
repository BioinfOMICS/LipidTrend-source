...
dataPATH <- "data/Viral_Infection_2/HSD17B12KO_sgCtrl/Acyl-linked FA"
outPATH <- "results/Viral_Infection_2/HSD17B12KO_sgCtrl/Acyl-linked FA"
...
data.table::fwrite(reg.tab$even_result, file.path(outPATH, "fattyAcylChain_1D_evenChain_regionalTestFC_result.csv"))
data.table::fwrite(reg.tab$odd_result, file.path(outPATH, "fattyAcylChain_1D_oddChain_regionalTestFC_result.csv"))
