...
for(weight in c('weighted', 'unweighted')){
  ...
  data.table::fwrite(reg.tab$even_result, file.path(outPATH, paste0(weight, "_totalChain_2D_evenChain_regionalTestFC_result.csv")))
  data.table::fwrite(reg.tab$odd_result, file.path(outPATH, paste0(weight, "_totalChain_2D_oddChain_regionalTestFC_result.csv")))
